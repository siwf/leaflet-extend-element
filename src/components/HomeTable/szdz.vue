<template>
  <div class="map-table">
    ...
    <div class="map-table--total">
      <p class="top-left">
        <img src="@/assets/img/table/szdz.png" alt="" style="width: 28px; height: 29px;" />
      </p>
      <p class="total--title">水自动站点总数</p>
      <div class="top-total">
...
<script>
import { getSzdzThemeInfo } from "@/api/waterMap";
export default {
  name: "SzdzTable",
  data() {
    return {
