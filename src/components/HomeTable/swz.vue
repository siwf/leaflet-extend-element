<template>
  <div class="map-table">
    ...
    <div class="map-table--total">
      <p class="top-left">
        <img src="@/assets/img/table/swz.png" alt="" style="width: 28px; height: 29px;" />
      </p>
      <p class="total--title">水文站点总数</p>
      <div class="top-total">
...
<script>
import { getThemeInfoSwz } from "@/api/waterMap";
export default {
  data() {
    return {
      tableData: [],
