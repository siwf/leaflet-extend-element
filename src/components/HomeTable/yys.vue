<template>
  <div class="map-table">
    ...
    <div class="map-table--total">
      <p class="top-left">
        <img src="@/assets/img/table/yys.png" alt="" style="width: 28px; height: 29px;" />
      </p>
      <p class="total--title">饮用水站点总数</p>
      <div class="top-total">
...
<script>
import { getThemeInfoYys } from "@/api/waterMap";
export default {
  name: "DbsTable",
  data() {
    return {
