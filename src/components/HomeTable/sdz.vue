<template>
  <div class="map-table">
    ...
    <div class="map-table--total">
      <p class="top-left">
        <img src="@/assets/img/table/sdz.png" alt="" style="width: 28px; height: 29px;" />
      </p>
      <p class="total--title">水电站点总数</p>
      <div class="top-total">
    ...
    <div class="map-table-wrapper">
      <el-table :data="tableData" style="width: 100%" :height="340" v-loading="loading" border>
        ...
        <el-table-column prop="rlName" label="河流" align="center">
        </el-table-column>
      </el-table>
    </div>
  </div>
...
<script>
import { getThemeInfoSdz } from "@/api/waterMap";
export default {
  data() {
    return {
      tableData: [],
