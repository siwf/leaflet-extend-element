<template>
  <div class="map-table">
    ...
    <div class="map-table--total">
      <p class="top-left">
        <img src="@/assets/img/table/rhpwk.png" alt="" style="width: 28px; height: 29px;" />
      </p>
      <p class="total--title">完成整治</p>
      <div class="top-total">
    ...
    <div class="map-table-wrapper">
      <el-table :data="tableData" style="width: 100%" :height="340" v-loading="loading" border>
        <el-table-column show-overflow-tooltip prop="staName" label="排口名称" align="center">
        </el-table-column>
        <el-table-column width="88" prop="regulation" label="是否完成整治" align="center">
        </el-table-column>
        <!-- <el-table-column
          prop="exceedStandard"
          label="超标情况"
...
<script>
import { getThemeInfoRhpwk } from "@/api/waterMap";
export default {
  data() {
    return {
      tableData: [],
